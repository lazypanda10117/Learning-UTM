    ...
    **Warning!** it is assumed that inputs are sampled randomly with 0.5 prob.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._max_raw_feature_size = max(self._task.input_size, self._task.output_size)
        ...
        if self._use_delimiters:
            ...
            self._output_delimiter = np.zeros((self._batch_size, 1, self.feature_size))
    ...
    def feature_size(self) -> int:
        return self._max_raw_feature_size + _NUM_DELIMITERS * int(self._use_delimiters)
    ...
    def _build_categorical_probs(self, s_batch: dict[str, np.ndarray]) -> np.ndarray:
